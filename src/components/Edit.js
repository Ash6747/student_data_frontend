...
const Edit = () => {
    ...
    const getdata = async () => {
        ...
        const res = await fetch(`http://localhost:5000/getstudent/${id}`, {
            method: "GET",
            headers: {
    ...
    const updateuser = async(e)=>{
        ...
        const {name,email,gender,add,mobile,desc,age} = inpval;

        const res2 = await fetch(`http://localhost:5000/updatestudent/${id}`,{
            method: "PATCH",
            headers: {
                "Content-Type": "application/json"
            },
            body:JSON.stringify({
                name,email,gender,add,mobile,desc,age
            })
        });
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" value={inpval.Class} onChange={setdata} name="Class" class="form-control" id="exampleInputPassword1" />
                    </div>
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
