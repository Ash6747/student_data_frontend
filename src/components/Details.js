...
const Details = () => {
    ...
    const deleteuser = async (id) => {
        ...
        const res2 = await fetch(`http://localhost:5000/deletestudent/${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            }
    ...
    return (
        <div className="container mt-3">
            <h1 style={{ fontWeight: 400 }}>Welcome Ashish Satpute</h1>
                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <p className="mt-3"><WorkIcon />Gender: <span>{getuserdata.gender}</span></p>
                        </div>
